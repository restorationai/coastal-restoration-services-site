...
generated_at: "2026-07-30T17:09:42.553194+00:00"
...
faq: [{"question": "How can I tell if the mold smell is coming from my HVAC system versus somewhere else in the house?", "answer": "The clearest test is timing: turn the system completely off for several hours and note whether the smell diminishes. Then run the fan on its own (fan-only mode, no heating or cooling) and stand near a supply vent \u2014 if the odor is noticeably stronger at the vent than in the center of the room, the source is almost certainly inside the air handler or ductwork. A musty smell that's consistent throughout the house regardless of HVAC operation is more likely coming from a wall cavity, crawl space, or attic."}, {"question": "Does homeowner's insurance cover mold remediation?", "answer": "It depends on the cause. Most standard homeowner's policies cover mold that results directly from a sudden, accidental covered event \u2014 like a pipe that burst or an appliance that failed \u2014 as long as the damage is reported promptly. Mold that developed gradually from a slow leak, chronic condensation, or deferred maintenance is typically excluded. Review your policy's mold endorsement language carefully, and document the moisture source and timeline before filing a claim."}, {"question": "Can I test for mold myself before calling a professional?", "answer": "Consumer mold test kits (the kind you leave open on a surface for 48 hours) will almost always show some mold spores, because mold spores exist in virtually every indoor environment at low levels. They can't tell you whether the concentration is elevated, where the source is, or what species is present. A moisture meter is a more actionable DIY tool \u2014 it tells you whether building materials are wet enough to support active growth. If you want a meaningful air quality or surface sample, hire a certified industrial hygienist who can interpret the results in context."}, {"question": "How long does mold remediation typically take, and can I stay in the house during the process?", "answer": "For a contained area like a single bathroom wall or a small section of crawl space, remediation often takes one to three days. Larger projects involving multiple rooms, HVAC systems, or extensive subfloor damage can run a week or more. Whether you can stay in the home depends on the size of the affected area and whether the contractor can establish effective containment \u2014 for significant mold in living areas or central HVAC systems, temporary relocation during active work is usually the safer and more practical choice."}]
...
Not all mold looks like the fuzzy black patches in photos. Early-stage colonies can appear as faint gray smudges, greenish streaks, or a white powdery film on grout, caulk, or drywall. A quick test: dab a drop of household bleach on the spot. If it lightens within a minute or two, it's likely biological growth. If it stays the same color, it's probably just dirt or a stain.
...
If the smell disappears when the system is off and returns the moment it cycles on, the growth is almost certainly inside the air handler, on the evaporator coil, or in the duct lining. This is one of the more serious scenarios because the system actively distributes spores throughout every room in the house every time it runs.
...
5. **Get a moisture reading.** Inexpensive pin-type moisture meters (under $30 at hardware stores) let you probe drywall and wood framing without opening walls. Readings above 20% in wood indicate active or recent moisture intrusion.
...
- Any situation where the source of moisture hasn't been fully identified
- Any household member with asthma, a compromised immune system, or mold sensitivity
- Any area larger than roughly 10 square feet

A qualified mold remediation contractor will use thermal imaging and calibrated moisture meters to map the full extent of the problem before opening anything up, then establish containment with negative air pressure to prevent cross-contamination during removal.
