...
generated_at: "2026-07-30T17:10:10.457876+00:00"
...
faq: [{"question": "How long does fire damage restoration typically take?", "answer": "It depends heavily on the size of the fire and whether suppression water introduced moisture that needs to dry before reconstruction can begin. A contained kitchen fire with moderate smoke damage might take two to four weeks from initial cleaning through repainting. A fire that spread to multiple rooms or the attic can take three to six months, particularly if structural framing needs replacement and permits are required for reconstruction. Your restoration contractor should be able to give you a phased timeline after the initial assessment."}, {"question": "Will my homeowner's insurance cover fire damage restoration?", "answer": "Most standard homeowner's policies cover fire damage, including smoke and water damage caused by firefighting efforts, under the dwelling coverage portion. Contents coverage handles personal belongings, and loss-of-use coverage may pay for temporary housing while the home is uninhabitable. The key is prompt notification to your carrier, thorough documentation before any cleanup begins, and working with a restoration contractor experienced in insurance billing \u2014 they can help ensure the scope of work is properly documented so nothing is left out of the claim."}, {"question": "Can smoke odor ever be fully eliminated, or does it always come back?", "answer": "Smoke odor can be fully eliminated, but only if every porous material that absorbed odor compounds is either cleaned to the molecular level or removed and replaced. Odor that seems to disappear and then returns \u2014 especially on humid days \u2014 usually means a hidden material (attic insulation, wall cavity framing, subfloor) wasn't treated. Professional methods like thermal fogging and hydroxyl generation are effective on accessible surfaces; sometimes the only permanent fix for deeply saturated materials is replacement. A thorough initial assessment that maps the full extent of smoke migration is what prevents callbacks."}, {"question": "Is it safe to stay in the house after a fire if the damage seems minor?", "answer": "That depends on the type of fire, what burned, and whether the structure was cleared by the fire department. Even a small fire involving synthetic materials \u2014 foam, plastics, vinyl \u2014 releases combustion byproducts that can be harmful to breathe in an enclosed space. Soot particles are fine enough to penetrate deep into the lungs. If the fire department has cleared the structure and the affected area is well-isolated and ventilated, short visits to retrieve belongings are generally manageable \u2014 but sleeping in a smoke-affected home before professional cleaning and air quality testing is not advisable. Consult with your restoration team and, if health concerns arise, your physician."}]
...
Well-meaning cleanup attempts are one of the most common ways fire damage gets worse before it gets better.
...
**3. Water extraction and drying (if applicable)**
Fire suppression water is addressed first. Standing water is extracted, affected materials are dried using industrial air movers and dehumidifiers, and moisture readings are taken to confirm structural materials reach acceptable levels. Skipping this step leads to mold growth within 24–48 hours.
...
Even after professional cleaning, some effects linger. Here's what the recovery arc typically looks like:

- **Week 1–2:** Emergency stabilization, water drying, initial soot cleaning, insurance adjuster visit.
- **Week 2–4:** Deep cleaning, odor treatment, content pack-out, scope of reconstruction finalized with adjuster.
