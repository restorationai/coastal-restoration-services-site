...
priority: 6.3
plan_hash: "7a587ddab2adf5c7"
generated_at: "2026-07-30T16:51:12.124006+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/arroyo-grande-ca/emergency-board-up-tarping/", "/service-areas/atascadero-ca/emergency-board-up-tarping/", "/service-areas/avila-beach-ca/emergency-board-up-tarping/", "/service-areas/ballard-ca/emergency-board-up-tarping/", "/service-areas/blacklake-ca/emergency-board-up-tarping/", "/service-areas/buellton-ca/emergency-board-up-tarping/", "/service-areas/callender-ca/emergency-board-up-tarping/", "/service-areas/cambria-ca/emergency-board-up-tarping/", "/service-areas/edna-ca/emergency-board-up-tarping/", "/service-areas/el-paso-de-robles-ca/emergency-board-up-tarping/", "/service-areas/grover-beach-ca/emergency-board-up-tarping/", "/service-areas/guadalupe-ca/emergency-board-up-tarping/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Emergency Board-Up and Tarping"}]
faq: [{"question": "Does homeowners insurance cover emergency board-up and tarping?", "answer": "Yes \u2014 most standard HO-3 homeowners policies cover emergency board-up and tarping as a protective or mitigation measure under the dwelling coverage section, though individual policies have varying sublimits for temporary repairs. Coastal Restoration Services Inc works with all insurance carriers and handles the claim documentation \u2014 photographs, measurements, and a written scope \u2014 so your adjuster has everything needed to process the expense without back-and-forth."}, {"question": "How long does a roof tarp installation actually last before it needs to be replaced or repaired?", "answer": "A properly battened heavy-duty polyethylene tarp installed with 2\u00d74 or 2\u00d76 battens screwed into solid decking can hold reliably for four to twelve weeks under normal conditions. UV exposure, foot traffic, and high-wind events degrade tarps faster \u2014 in a coastal environment with strong offshore winds, tarps should be inspected after any significant weather event. They are a temporary measure, not a substitute for permanent roof repair, and most insurance policies expect permanent repairs to begin within a reasonable timeframe after the loss."}, {"question": "What size and type of plywood should be used for boarding up windows and doors?", "answer": "The industry standard for residential board-up is \u00be-inch exterior-grade plywood (CDX or better) fastened with structural screws into the rough-opening framing, not into drywall or stucco. For spans wider than about 48 inches \u2014 large picture windows, sliding glass doors, garage openings \u2014 thicker stock or additional blocking is needed to prevent deflection under wind load. Half-inch OSB, which is sometimes used to cut costs, is not adequate for large openings and will flex enough to pull fasteners loose in a moderate wind event."}, {"question": "Can I board up my own windows after a fire before the fire marshal clears the scene?", "answer": "You should coordinate with the fire marshal or incident commander before sealing any openings on a fire-damaged structure. Fire investigators may need continued access, and sealing the structure prematurely can create spoliation-of-evidence issues that complicate both the fire investigation and your insurance claim. A professional board-up crew familiar with fire loss protocols will sequence the work around investigator access and can install removable panel sections where re-entry is anticipated."}, {"question": "What's the difference between a tarp that's weighted down versus one that's battened and screwed?", "answer": "A weighted tarp \u2014 sandbags, bricks, or debris piled on top \u2014 relies entirely on gravity and has no resistance to uplift forces. Wind gets under the tarp edge, creates a sail effect, and the whole assembly can peel off in a gust that would barely register on a weather app. A battened tarp uses 2\u00d74 or 2\u00d76 lumber screwed through the tarp material into the roof decking or rafters, mechanically fastening the tarp at regular intervals so wind pressure is distributed across the fastener pattern rather than concentrated at the edges. Insurance adjusters and building inspectors recognize the difference, and a failed weighted tarp that allows secondary water intrusion may be treated as inadequate mitigation."}]
...
|---|---|
| Single broken window, standard residential | $150 – $400 |
| Multiple windows and a door (e.g., after break-in or fire) | $600 – $1,500 |
| Small roof tarp (up to 10 squares) | $800 – $2,000 |
| Large or steep roof tarp (10+ squares, complex pitch) | $2,000 – $5,000 |
...
Coastal Restoration Services Inc is based in Vandenberg Village and provides emergency board-up and tarping throughout the surrounding area, including Lompoc, Santa Maria, Orcutt, Buellton, Solvang, and communities along the Highway 1 corridor. Individual service-area pages detail response coverage for each city.

If your home or building has an open breach right now, call **(805) 345-7440** to get a crew dispatched and start the documentation your insurance claim will need.
